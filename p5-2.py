...
ft, fe, fp, fc = feature_transition, feature_emission, feature_POS, feature_combine
...
if __name__ == "__main__":
    ...
    # Inference
    X_dev = read_file("../data/partial/dev.in", 0)
	Y_dev = read_file("../data/partial/dev.out", 1)

	save_path = "../result/dev_test.p5.CRF.f4.out"
	f = open(save_path, 'w')
	evals = []
