...
def compute_score(x_instance, x_instance_pos, x_instance_new, y_instance, feature_dict):
    ...
    for x, y in zip(x_instance_new, y_instance): feature_count[f"emission:{y}+{x}"] += 1
